...
namespace FPS_Movement_Control
{
    ...
    public class PlayerMovement : InterpolatedTransform
    {
        ...
        [Header("Footsteps")]
        [SerializeField]
        private LayerMask footstepsLayer;
        [SerializeField]
        ...
        {
            t_status = PlayController.GetInstance().move_Current;
        ...
        public bool CancelCrouch()
        {
            ...
            bool isBlocked = 
                Physics.SphereCast(
                    ...
                    PlayController.GetInstance().layer_moveCollsion);
            if (isBlocked)
                return false; 
        ...
        private void FootstepSet()
        {
            ...
            if (is_Grounded && distanceTravelled > footstepInterval && (int)t_status < 4)
            {
                distanceTravelled = 0;
                footTurn = -footTurn;
